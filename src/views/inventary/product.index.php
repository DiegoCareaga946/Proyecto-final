            ...
            <div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <div class="bg-[#DC9D5A] justify-items-center rounded-xl shadow-md hover:shadow-lg">
                    ...
                    <div class="p-6 text-center">
                        ...
                        <div class="m-4">
                            <a href="<?=SRC_PATH?>/views/inventary/product.details.php?Id=<?=$producto['id']?>" class="bg-[#906646] font-bold cursor-pointer rounded-lg p-3 hover:text-[#906646] hover:bg-white transition">VER MAS</a>
                        </div>
                    </div>
                </div>
                <?php endforeach; ?>
